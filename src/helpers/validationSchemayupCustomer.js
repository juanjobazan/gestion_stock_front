...
nombreApellido: yup.string().required('El Campo Nombre y Apellido es Obligatorio').max(45,'El Maximo es de 45 Caracteres').min(8,'El Minimo es de 8 caracteres'),
...
email: yup.string().required('El Campo Email es Obligatorio').email('No es un Email Valido'),
