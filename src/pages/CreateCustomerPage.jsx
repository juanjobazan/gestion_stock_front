...
const CreateCustomerPage = () => {
    return (
        <>
            <Formik
                initialValues={{ nombreApellido: '', dni: '', email: '', direccion: '' }}
                                ...
                                <Form>
                                    ...
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                        ...
                                        <div className="input-group form-group">
                                            ...
                                            <Form.Control type="text" name='nombreApellido' placeholder="Ingrese Nombre y Apellido" maxLength={64} value={values.nombreApellido} className={errors.nombreApellido && touched.nombreApellido && errors.nombreApellido && 'is-invalid'} onChange={handleChange} />
                                        </div>
                                        <small className='text-danger'>{errors.nombreApellido && touched.nombreApellido && errors.nombreApellido}</small>
                                    </Form.Group>
                                    ...
                                    <Form.Label className='letra'>Email</Form.Label>
                                    <Form.Group className="mb-3" controlId="formBasicPassword">
                                        <div className="input-group form-group">
                                            <div className="input-group-prepend">
                                            ...
                                            <Form.Control type="text" name='email' placeholder="Ingrese el Email" maxLength={32} value={values.email} className={errors.email && touched.email && errors.email && 'is-invalid'} onChange={handleChange} />
                                        </div>
